...
public class AccountsControllerTest {
  ...
  public void transferMoney_Success() throws Exception{
    ...
    this.mockMvc.perform(post("/v1/accounts/account-transfer")
        .param("fromAccountId", fromAccountId)
        .param("toAccountId", toAccountId)
        .param("balance", balance.toString()))
        .andExpect(status().isOk())
        .andExpect(
            content().string("Account transfer is successful"));

  }

  @Test
  public void transferMoney_FailureInCaseOfNoParamsPassed() throws Exception{
